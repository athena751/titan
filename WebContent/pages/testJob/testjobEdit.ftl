...
<tr>
  ...
  <td align="left" width="90%">
  		<input id="testjob.jobType" name="testjob.jobType" type="text" class="input_text" value="${testjob.jobType!""}" readonly="true" />
</td>
</tr>
<tr>
...
<tr>
	...
	<td align="left" width="90%">
		<select id="projectId" name="testjob.projectId"  class="select" style="width:180px">
			<option value="" selected>Please Select</option>
...
<tr>
	...
	<td align="left" width="90%">
	    ...
	    <tr></tr>
	    <#if jobserverList?has_content>
	     <#list jobserverList as jobserver >
	       <tr>
	        <td><select class='select' style='width:180px'>
	              <option value=''selected >Please Select</option>
	              <#list serverList as server>
				     <option value="${server.serverId}"<#if '${server.serverId!""}'=='${jobserver.serverId!""}'>selected</#if>>${server.serverName}</option>
			     </#list> 
	          </select>
	        </td>
