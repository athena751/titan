...
function save(){    
   doFormSubmit('serverRegForm', 'doServerUpdate.do?serverId='+"${(server.serverId)!''}");   
}
function cancel() {
...
<div class="box">
	<table class="tablecontent" width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
	       ...
	       <td align="left" width="90%">
	        <select id="status" name="server.status" class="select"  style="width:180px">
        		<option value="used"  <#if '${server.serverStatus!""}'=='used'>selected</#if>>used</option>
        		<option value="not used"  <#if '${server.serverStatus!""}'=='not used'>selected</#if>>not used</option>
		    </select>
		...
		<tr>
			...
			<td align="left" width="90%">${server.sn!""}
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="left" width="90%">${server.macAddr!""}
			</td>
		</tr>
	
		<tr>
			<td class="tablecontent_title" align="right" width="10%">Memory：</td>
			<td align="left" width="90%">${server.memory!""}
			</td>
		</tr>	
		<tr>
			<td class="tablecontent_title" align="right" width="10%">CPU：</td>
			<td align="left" width="90%">${server.cpu!""}
			</td>
		</tr>		
		</tr>
	       <td align="right" class="tablecontent_title" width="10%">Purchase Date：</td>
	       <td align="left" width="90%"><input id="purchaseDate" name="server.purchaseDate" type="text" class="mh_date" value="${server.purchaseDate!""}"/></td></td>
        <tr>
		<tr>
