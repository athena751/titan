...
<script>
function doAnd(){
	doFormSubmit('andUserFormId','goAllUsersList.do')
}
function doDelete(){
	if(checkBox('delete','userIdAry')){
 		doFormSubmit('andUserFormId','doDeleteGroupUser.do')
 	}
} 
...
<body>
<div class="port_bar"><span class="marfin_lef10">Users</span><span class="marfin_lef5">></span><span class="marfin_lef5">User Groups Manage</span><span class="marfin_lef5">></span><span class="marfin_lef5">Manage Users</span></div>
<div class="title"><img src="${base}/images/titleico.gif" width="18" height="15" class="ico" />Manage Users (User Groups:${group.groupName!''})</div>
      ...
      <table id="pageTable" width="100%" border="0" cellpadding="0" cellspacing="0" class="tlist">
           <thead>
		        ...
		        <th width="20%" class="table_header_complex_c">E-mail</th>
		     	<th width="16%" class="table_header_complex_c">User Group</th>
		     	<th width="15%" class="table_header_complex_c">Role</th>
			</thead>
		<tbody>	
           <#if group.users?has_content >
