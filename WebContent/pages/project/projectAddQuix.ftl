...
function onSave() {
   ...
   if(reportaryId != ""){
      ...
      doFormSubmit('projectQuixForm','doProjectAddQuix.do');
   //}
}
function onBack() {
...
function checkInput() {
	...
	if('OK' != projectRallyQuixMessage){
		alert('There is some error on name in Quix, please check it!');
		return;
	}
	onSave();
}
...
$(document).ready(function(){
	...
	$("#projectRallyQuix").blur(function(){
		...
		if('' == projectRallyQuix){
			$("#projectRallyQuixMessage").html('<div class="messageNG">Please enter the name in Quix!');
		}
		else{
...
<body>
 <form id="projectQuixForm" name="projectQuixForm" method="post">
...
<tr>
  <td align="right" class="tablecontent_title" width="10%">Name in Quix:</td>
  <td align="left" width="90%"><input id="projectRallyQuix" name="projectRallyQuix.nameinQuix" type="text" class="input_text" value="${projectRallyQuix.nameinQuix!""}" /><span id="projectRallyQuixMessage"></span>
  </td>
</tr>
<tr>
  <td align="right" class="tablecontent_title" width="10%">Component:</td>
  <td align="left" width="90%"><input id="component" name="projectRallyQuix.component" type="text" class="input_text" value="${projectRallyQuix.component!""}" /><span id="componentMessage"></span>
  </td>
</tr>
<tr>
