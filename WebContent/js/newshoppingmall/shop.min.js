...
function(t, e, a, n) {
    ...
    t.extend(i.prototype, {
        ...
        checkout: function() {
            ...
            i.append('<input type="hidden" id="jsonObj" />');
    			...
    			success : function(msg) {				      
    				if(msg == 'yes'){
    					if(confirm('Are you want to use ' + totalPrice + ' to buy those goods?')){
    						$.ajax( {
    			    			type : 'post',
    			    			url : 'doSaveNewConsume.do?t=' + new Date().getTime(),
    			    			dataType: "text",
    			    			data : { 
    			    					 'jsonObj' : JSON.stringify(jsonObj)
    			    			 },
    			    			success : function(msg) {
    			    				var action = "goMyConsumeList.do";
    			    				if(msg == 'yes'){
    			    					action = "goGamblingList.do";
    			    				}
    			    				i.attr("action", action),
    			    				t("body").append(i),
    		    			        i.submit(); 
    			    			}
    			    		});
        ...
        create_storage_cart: function() {
            for (var t = this,
            e = t.storage_get(), a = 0, n = e.items.length; n > a; a++) {
                var i = e.items[a].id,
                r = e.items[a].name,
                s = e.items[a].price,
                c = e.items[a].input;
